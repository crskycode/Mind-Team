...
{
public:
	ActiveGrenade( CBaseEntity *grenadeEntity );
	...
	bool IsEntity( CBaseEntity *grenade ) const		{ return (grenade == m_entity) ? true : false; }
	CBaseEntity *GetEntity( void ) const				{ return m_entity; }
	...
	CBaseEntity *GetGrenade( void ) { return m_entity; }
	float GetRadius( void ) const { return m_radius; }
	void SetRadius( float radius ) { m_radius = radius; }

private:
	CBaseEntity *m_entity;									///< the entity
...
public:
	...
	virtual bool ClientCommand( CBasePlayer *player ) = 0;
	...
	void AddGrenade( CBaseEntity *grenade );					///< add an active grenade to the bot's awareness
	void RemoveGrenade( CBaseEntity *grenade );				///< the grenade entity in the world is going away
	void SetGrenadeRadius( CBaseEntity *grenade, float radius );	///< the radius of the grenade entity (or associated smoke cloud)
