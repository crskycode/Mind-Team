...
{
public:
	CollectArriveFirstSpotsFunctor( CBasePlayer *me, const Vector &searchOrigin, float enemyArriveTime, float range, int flags ) : m_searchOrigin( searchOrigin )
	{
		m_me = me;
		m_count = 0;
		m_range = range;
 ...
 * NOTE: This only works for the initial rush.
 */
const HidingSpot *FindInitialEncounterSpot( CBasePlayer *me, const Vector &searchOrigin, float enemyArriveTime, float maxRange, bool isSniper )
{
