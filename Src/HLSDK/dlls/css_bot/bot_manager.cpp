 ...
 */
void CBotManager::AddGrenade( CBaseEntity *grenade )
{
 ...
 */
void CBotManager::RemoveGrenade( CBaseEntity *grenade )
{
	FOR_EACH_LL( m_activeGrenadeList, it )
	{
		ActiveGrenade *ag = m_activeGrenadeList[ it ];
 ...
 */
void CBotManager::SetGrenadeRadius( CBaseEntity *grenade, float radius )
{
	FOR_EACH_LL( m_activeGrenadeList, it )
	{
		ActiveGrenade *ag = m_activeGrenadeList[ it ];
...
void CBotManager::AddDebugMessage( const char *msg )
{
	...
	strncpy( m_debugMessage[ m_currentDebugMessage ].m_string, msg, MAX_DBG_MSG_SIZE );
