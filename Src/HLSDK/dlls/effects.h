...
public:
	...
	void SpriteInit( const char *pSpriteName, Vector &origin );
	...
	static CSprite *SpriteCreate( const char *pSpriteName, Vector &origin, BOOL animate );
...
public:
	...
	inline void SetStartPos( Vector &pos ) { pev->origin = pos; }
	inline void SetEndPos( Vector &pos ) { pev->angles = pos; }
	...
	void PointsInit( Vector &start, Vector &end );
	void PointEntInit( Vector &start, int endIndex );
	void EntsInit( int startIndex, int endIndex );
	void HoseInit( Vector &start, Vector &direction );
