...
#define CBTEXTURENAMEMAX	32

#define CHAR_TEX_BROKENGLASS	'A'		/* 玻璃 */
#define CHAR_TEX_CARPET			'B'		/* 地毯 */
#define CHAR_TEX_CUSHION		'C'		/* 垫子 */
#define CHAR_TEX_DIRT			'D'		/* 泥土 */
#define CHAR_TEX_METAL			'E'		/* 金属 */
#define CHAR_TEX_SNOW			'F'		/* 积雪 */
#define CHAR_TEX_STONE			'G'		/* 石头 */
#define CHAR_TEX_SWAMP			'H'		/* 湿地 */
#define CHAR_TEX_TREE			'I'		/* 木材 */
#define CHAR_TEX_WATER			'J'		/* 水面 */

#define STEP_NONE			0
#define STEP_BROKENGLASS	1
#define STEP_CARPET			2
#define STEP_CUSHION		3
#define STEP_DIRT			4
#define STEP_METAL			5
#define STEP_SNOW			6
#define STEP_STONE			7
...
void PM_PlayStepSound( int step, float fvol )
{
	...
	switch ( step )
	{
		case STEP_BROKENGLASS:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_brokenglass1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_brokenglass2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_brokenglass3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_brokenglass4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_brokenglass5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_brokenglass6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_brokenglass1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_brokenglass2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_brokenglass3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_brokenglass4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_brokenglass5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_brokenglass6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		...
		case STEP_CARPET:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_carpet1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_carpet2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_carpet3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_carpet4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_carpet5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_carpet6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_carpet1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_carpet2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_carpet3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_carpet4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_carpet5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_carpet6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		...
		case STEP_CUSHION:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_cushion1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_cushion2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_cushion3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_cushion4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_cushion5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_cushion6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_cushion1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_cushion2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_cushion3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_cushion4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_cushion5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_cushion6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		...
		case STEP_DIRT:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_dirt1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_dirt2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_dirt3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_dirt4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_dirt5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_dirt6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_dirt1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_dirt2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_dirt3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_dirt4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_dirt5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_dirt6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		...
		case STEP_METAL:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_metal1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_metal2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_metal3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_metal4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_metal5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_metal6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_metal1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_metal2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_metal3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_metal4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_metal5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_metal6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		...
		case STEP_SNOW:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_snow1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_snow2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_snow3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_snow4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_snow5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_snow6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_snow1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_snow2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_snow3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_snow4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_snow5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_snow6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		...
		case STEP_STONE:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_stone1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_stone2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_stone3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_stone4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_stone5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_stone6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_stone1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_stone2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_stone3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_stone4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_stone5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_stone6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		...
		case STEP_TREE:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_tree1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_tree2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_tree3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_tree4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_tree5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_tree6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_tree1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_tree2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_tree3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_tree4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_tree5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_tree6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		...
		case STEP_WATER:
		{
			switch ( irand )
			{
				case -1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_water1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_water2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_water3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_water4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_water5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case -6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_left_water6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  1: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_water1.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  2: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_water2.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  3: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_water3.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  4: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_water4.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  5: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_water5.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
				case  6: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_right_water6.wav", fvol, ATTN_NORM, 0, PITCH_NORM ); break;
			}
...
int PM_MapTextureTypeStepType(char chTextureType)
{
	...
	{
		case CHAR_TEX_BROKENGLASS: return STEP_BROKENGLASS;
		case CHAR_TEX_CARPET: return STEP_CARPET;
		case CHAR_TEX_CUSHION: return STEP_CUSHION;
		case CHAR_TEX_DIRT: return STEP_DIRT;
		case CHAR_TEX_METAL: return STEP_METAL;
		case CHAR_TEX_SNOW: return STEP_SNOW;
		case CHAR_TEX_STONE: return STEP_STONE;
		case CHAR_TEX_SWAMP: return STEP_SWAMP;
		case CHAR_TEX_TREE: return STEP_TREE;
		case CHAR_TEX_WATER: return STEP_WATER;
	}
...
void PM_CatagorizeTextureType( void )
{
	...
	pmove->chtexturetype = CHAR_TEX_DIRT;
...
void PM_UnDuck( void )
{
	...
	if ( !trace.startsolid )
	{
		...
		pmove->bInDuck  = false;
		pmove->view_ofs[2] = VEC_IDLE_VIEW[2];
		pmove->flDuckTime = 0;
	...
	if ( ( pmove->cmd.buttons & IN_DUCK ) || ( pmove->bInDuck ) || ( pmove->flags & FL_DUCKING ) )
	{
		if ( pmove->cmd.buttons & IN_DUCK )
		{
			...
			if ( pmove->bInDuck )
			{
				...
				{
					float fMore = (VEC_DUCK_HULL_MIN[2] - VEC_IDLE_HULL_MIN[2]);

					// Calc parametric time
					duckFraction = PM_SplineFraction( time, (1.0/TIME_TO_DUCK) );
					pmove->view_ofs[2] = ((VEC_DUCK_VIEW[2] - fMore ) * duckFraction) + (VEC_IDLE_VIEW[2] * (1-duckFraction));
				}
			}
		}
		else
...
void PM_Jump (void)
{
	...
	//{
	//	case CHAR_TEX_BROKENGLASS: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_brokenglass.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_CARPET: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_carpet.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_CUSHION: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_cushion.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_DIRT: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_dirt.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_METAL: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_metal.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_SNOW: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_snow.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_STONE: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_stone.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_SWAMP: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_swamp.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_TREE: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_tree.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//	case CHAR_TEX_WATER: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_jump_water.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
	//}
}
...
//switch ( pmove->chtexturetype )
//{
//	case CHAR_TEX_BROKENGLASS: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_brokenglass.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_CARPET: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_carpet.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_CUSHION: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_cushion.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_DIRT: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_dirt.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_METAL: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_metal.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_SNOW: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_snow.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_STONE: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_stone.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_SWAMP: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_swamp.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_TREE: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_tree.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//	case CHAR_TEX_WATER: pmove->PM_PlaySound( CHAN_BODY, "player/c_run_drop_water.wav", 1, ATTN_NORM, 0, PITCH_NORM ); break;
//}
...
void PM_Init( struct playermove_s *ppmove )
{
	...
	VectorCopy(VEC_IDLE_HULL_MIN, ppmove->player_mins[0]);
	VectorCopy(VEC_IDLE_HULL_MAX, ppmove->player_maxs[0]);
	VectorCopy(VEC_DUCK_HULL_MIN, ppmove->player_mins[1]);
	VectorCopy(VEC_DUCK_HULL_MAX, ppmove->player_maxs[1]);
