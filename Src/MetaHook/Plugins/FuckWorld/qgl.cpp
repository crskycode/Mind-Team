...
void (APIENTRY *qglCompressedTexImage3DARB)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void *data) = NULL;
void (APIENTRY *qglCompressedTexImage2DARB)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void *data) = NULL;
void (APIENTRY *qglCompressedTexImage1DARB)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void *data) = NULL;
void (APIENTRY *qglCompressedTexSubImage3DARB)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void *data) = NULL;
void (APIENTRY *qglCompressedTexSubImage2DARB)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void *data) = NULL;
void (APIENTRY *qglCompressedTexSubImage1DARB)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void *data) = NULL;
void (APIENTRY *qglGetCompressedTexImageARB)(GLenum target, GLint level, void *img) = NULL;
...
GLboolean (APIENTRY *qglIsRenderbuffer)(GLuint renderbuffer) = NULL;
void (APIENTRY *qglBindRenderbuffer)(GLenum target, GLuint renderbuffer) = NULL;
void (APIENTRY *qglDeleteRenderbuffers)(GLsizei n, const GLuint *renderbuffers) = NULL;
void (APIENTRY *qglGenRenderbuffers)(GLsizei n, GLuint *renderbuffers) = NULL;
void (APIENTRY *qglRenderbufferStorage)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height) = NULL;
void (APIENTRY *qglGetRenderbufferParameteriv)(GLenum target, GLenum pname, GLint *params) = NULL;
GLboolean (APIENTRY *qglIsFramebuffer)(GLuint framebuffer) = NULL;
void (APIENTRY *qglBindFramebuffer)(GLenum target, GLuint framebuffer) = NULL;
void (APIENTRY *qglDeleteFramebuffers)(GLsizei n, const GLuint *framebuffers) = NULL;
void (APIENTRY *qglGenFramebuffers)(GLsizei n, GLuint *framebuffers) = NULL;
GLenum (APIENTRY *qglCheckFramebufferStatus)(GLenum target) = NULL;
void (APIENTRY *qglFramebufferTexture1D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) = NULL;
void (APIENTRY *qglFramebufferTexture2D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) = NULL;
void (APIENTRY *qglFramebufferTexture3D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset) = NULL;
void (APIENTRY *qglFramebufferRenderbuffer)(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer) = NULL;
void (APIENTRY *qglGetFramebufferAttachmentParameteriv)(GLenum target, GLenum attachment, GLenum pname, GLint *params) = NULL;
void (APIENTRY *qglGenerateMipmap)(GLenum target) = NULL;
void (APIENTRY *qglBlitFramebuffer)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter) = NULL;
void (APIENTRY *qglRenderbufferStorageMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) = NULL;
void (APIENTRY *qglFramebufferTextureLayer)(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer) = NULL;

/* GL_ARB_vertex_buffer_object */
void (APIENTRY *qglBindBufferARB)(GLenum target, GLuint buffer) = NULL;
void (APIENTRY *qglDeleteBuffersARB)(GLsizei n, const GLuint *buffers) = NULL;
void (APIENTRY *qglGenBuffersARB)(GLsizei n, GLuint *buffers) = NULL;
GLboolean (APIENTRY *qglIsBufferARB)(GLuint buffer) = NULL;
void (APIENTRY *qglBufferDataARB)(GLenum target, GLsizeiptrARB size, const void *data, GLenum usage) = NULL;
void (APIENTRY *qglBufferSubDataARB)(GLenum target, GLintptrARB offset, GLsizeiptrARB size, const void *data) = NULL;
void (APIENTRY *qglGetBufferSubDataARB)(GLenum target, GLintptrARB offset, GLsizeiptrARB size, void *data) = NULL;
void *(APIENTRY *qglMapBufferARB)(GLenum target, GLenum access) = NULL;
GLboolean (APIENTRY *qglUnmapBufferARB)(GLenum target) = NULL;
void (APIENTRY *qglGetBufferParameterivARB)(GLenum target, GLenum pname, GLint *params) = NULL;
void (APIENTRY *qglGetBufferPointervARB)(GLenum target, GLenum pname, void **params) = NULL;

/* GLU */
int (APIENTRY *qgluBuild2DMipmaps)(GLenum target, GLint components, GLint width, GLint height, GLenum format, GLenum type, const void  *data) = NULL;
...
void QGL_Init(void)
{
	...
	if (hOpenGL)
	{
		...
		*(FARPROC *)&qglGetTexLevelParameterfv = GetProcAddress(hOpenGL, "glGetTexLevelParameterfv");
		*(FARPROC *)&qglGetTexLevelParameteriv = GetProcAddress(hOpenGL, "glGetTexLevelParameteriv");
		...
		*(FARPROC *)&qglViewport = GetProcAddress(hOpenGL, "glViewport");
		...
		const char *szVersion = (const char *)qglGetString(GL_VERSION);

		if (szVersion[0] < '2')
		{
			Sys_Error("Couldn't initialize OpenGL\nVersion: %s", szVersion);
			return;
		}
		...
		*(FARPROC *)&qwglGetProcAddress = GetProcAddress(hOpenGL, "wglGetProcAddress");
		...
		HMODULE hGLU = LoadLibrary("glu32.dll");

		if (hGLU)
		{
			*(void **)&qgluBuild2DMipmaps = GetProcAddress(hGLU, "gluBuild2DMipmaps");
		}
	}
	else
	{
...
void QGL_InitExtensions(void)
{
	...
	if (strstr(szExtensions, "GL_EXT_texture_compression_s3tc"))
	{
		*(PROC *)&qglCompressedTexImage3DARB = qwglGetProcAddress("glCompressedTexImage3DARB");
		*(PROC *)&qglCompressedTexImage2DARB = qwglGetProcAddress("glCompressedTexImage2DARB");
		*(PROC *)&qglCompressedTexImage1DARB = qwglGetProcAddress("glCompressedTexImage1DARB");
		*(PROC *)&qglCompressedTexSubImage3DARB = qwglGetProcAddress("glCompressedTexSubImage3DARB");
		*(PROC *)&qglCompressedTexSubImage2DARB = qwglGetProcAddress("glCompressedTexSubImage2DARB");
		*(PROC *)&qglCompressedTexSubImage1DARB = qwglGetProcAddress("glCompressedTexSubImage1DARB");
		*(PROC *)&qglGetCompressedTexImageARB = qwglGetProcAddress("glGetCompressedTexImageARB");
	}
	else
	{
		gEngfuncs.Con_DPrintf("OpenGL extension \"GL_EXT_texture_compression_s3tc\" not found\n");
	}
	...
	if (strstr(szExtensions, "GL_ARB_framebuffer_object"))
	{
		*(PROC *)&qglIsRenderbuffer = qwglGetProcAddress("glIsRenderbuffer");
		*(PROC *)&qglBindRenderbuffer = qwglGetProcAddress("glBindRenderbuffer");
		*(PROC *)&qglDeleteRenderbuffers = qwglGetProcAddress("glDeleteRenderbuffers");
		*(PROC *)&qglGenRenderbuffers = qwglGetProcAddress("glGenRenderbuffers");
		*(PROC *)&qglRenderbufferStorage = qwglGetProcAddress("glRenderbufferStorage");
		*(PROC *)&qglGetRenderbufferParameteriv = qwglGetProcAddress("glGetRenderbufferParameteriv");
		*(PROC *)&qglIsFramebuffer = qwglGetProcAddress("glIsFramebuffer");
		*(PROC *)&qglBindFramebuffer = qwglGetProcAddress("glBindFramebuffer");
		*(PROC *)&qglDeleteFramebuffers = qwglGetProcAddress("glDeleteFramebuffers");
		*(PROC *)&qglGenFramebuffers = qwglGetProcAddress("glGenFramebuffers");
		*(PROC *)&qglCheckFramebufferStatus = qwglGetProcAddress("glCheckFramebufferStatus");
		*(PROC *)&qglFramebufferTexture1D = qwglGetProcAddress("glFramebufferTexture1D");
		*(PROC *)&qglFramebufferTexture2D = qwglGetProcAddress("glFramebufferTexture2D");
		*(PROC *)&qglFramebufferTexture3D = qwglGetProcAddress("glFramebufferTexture3D");
		*(PROC *)&qglFramebufferRenderbuffer = qwglGetProcAddress("glFramebufferRenderbuffer");
		*(PROC *)&qglGetFramebufferAttachmentParameteriv = qwglGetProcAddress("glGetFramebufferAttachmentParameteriv");
		*(PROC *)&qglGenerateMipmap = qwglGetProcAddress("glGenerateMipmap");
		*(PROC *)&qglBlitFramebuffer = qwglGetProcAddress("glBlitFramebuffer");
		*(PROC *)&qglRenderbufferStorageMultisample = qwglGetProcAddress("glRenderbufferStorageMultisample");
		*(PROC *)&qglFramebufferTextureLayer = qwglGetProcAddress("glFramebufferTextureLayer");
	}
	else
	{
		Sys_Error("OpenGL extension \"GL_ARB_framebuffer_object\" not found");
	}

	if (strstr(szExtensions, "GL_ARB_vertex_buffer_object"))
	{
		*(PROC *)&qglBindBufferARB = qwglGetProcAddress("glBindBufferARB");
		*(PROC *)&qglDeleteBuffersARB = qwglGetProcAddress("glDeleteBuffersARB");
		*(PROC *)&qglGenBuffersARB = qwglGetProcAddress("glGenBuffersARB");
		*(PROC *)&qglIsBufferARB = qwglGetProcAddress("glIsBufferARB");
		*(PROC *)&qglBufferDataARB = qwglGetProcAddress("glBufferDataARB");
		*(PROC *)&qglBufferSubDataARB = qwglGetProcAddress("glBufferSubDataARB");
		*(PROC *)&qglGetBufferSubDataARB = qwglGetProcAddress("glGetBufferSubDataARB");
		*(PROC *)&qglMapBufferARB = qwglGetProcAddress("glMapBufferARB");
		*(PROC *)&qglUnmapBufferARB = qwglGetProcAddress("glUnmapBufferARB");
		*(PROC *)&qglGetBufferParameterivARB = qwglGetProcAddress("glGetBufferParameterivARB");
		*(PROC *)&qglGetBufferPointervARB = qwglGetProcAddress("glGetBufferPointervARB");
	}
}